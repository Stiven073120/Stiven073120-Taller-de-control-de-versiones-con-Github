SubProceso  opcion_5 ( nombres, cedulas, telefonos, cursos, estados_cursos)
	// Se definen las variables como
	Definir opcion, i, cupos, cont, pos_tem_pendientes  Como Entero;
	Definir lleno, existe Como Logico;
	Definir pasar, nombre, cedula, telefono Como Caracter;
...
SubProceso  opcion_4 ( nombres, cedulas, telefonos, cursos, estados_cursos)
	// Se definen las variables como
	Definir opcion, i, cupos, cont, pos_tem_pendientes  Como Entero;
	Definir lleno, existe Como Logico;
	Definir pasar, nombre, cedula, telefono Como Caracter;
...
SubProceso  opcion_3 (nombres, cedulas, telefonos, cursos, estados_cursos)
	// Se definen las variables como
	Definir opcion, i, cupos, cont, pos_tem_pendientes  Como Entero;
	Definir lleno, existe Como Logico;
	Definir pasar, nombre, cedula, telefono Como Caracter;
...
SubProceso  opcion_2 ( nombres, cedulas, telefonos, cursos, estados_cursos)
	// Se definen las variables como
	Definir opcion, i, cupos, cont, pos_tem_pendientes  Como Entero;
	Definir lleno, existe Como Logico;
	Definir pasar, nombre, cedula, telefono Como Caracter;
...
// proceso principal
Proceso escuela_automovilistica_funciones
	// Se definen las variables como
	Definir opcion, i, cupos, cont, pos_tem_pendientes  Como Entero;
	...
	Mientras estado Hacer
		...
		Segun opcion Hacer
			1:
				opcion_1();
			2:
				opcion_2(nombres, cedulas, telefonos, cursos, estados_cursos);	
			3:
				opcion_3(nombres, cedulas, telefonos, cursos, estados_cursos);
			4:
				opcion_4(nombres, cedulas, telefonos, cursos, estados_cursos);
			5:	
				opcion_5(nombres, cedulas, telefonos, cursos, estados_cursos);
			6:
				// Salir
				Limpiar Pantalla;
