// funcion
SubProceso opcion_3 ( telefono, nombre, organizacion )
...
SubProceso opcion_2 (nombre, telefono, organizacion )
	// se definen variables como
...
SubProceso opcion_1 ( telefono, nombre, organizacion )
	// se definen variables como
	Definir estado_2 Como Logico; 
	Definir i Como Entero;
	Definir pasar, numero_telefonico, nomb, org Como Caracter;
...
Proceso almacenar_contactos
	...
	Mientras estado = Verdadero Hacer
		...
		Segun opcion Hacer
			1:
				opcion_1(nombre, telefono, organizacion);
			2:
				opcion_2(nombre, telefono, organizacion);
			3:
				opcion_3(nombre, telefono, organizacion);
			4:
				// salir 
				Limpiar Pantalla;
