// funcion
SubProceso opciones_video_tienda ( opcion_1, nombre )
	// variables definidas como:
	Definir nombre_pelicula, opcion_anotacion,anotacion Como Caracter;
	Definir opcion_2, opcion_3 Como Entero;
...
// proceso principal
Proceso la_video_tienda_funciones
	...
	opciones_video_tienda(opcion_1, nombre);
