SubProceso opciones_drogeria ( opcion_inicial, nombre)
	// se definen variables como
	Definir razon_devolucion, nombre_producto Como Caracter;
	Definir opcion_categoria, opcion_compra, opcion_devolucion Como Entero;
...
// proceso principal
Proceso la_drogeria_funciones
	// se definen variables como
	Definir nombre Como Caracter;
	Definir opcion_inicial Como Entero;
	...
	opciones_drogeria(opcion_inicial, nombre);
