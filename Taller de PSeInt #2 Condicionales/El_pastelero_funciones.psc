// funcion
SubProceso opciones_pastelero ( opcion_torta, nombre)
	// Definir variables como
	Definir direccion, telefono, opcion_domicilio Como Caracter;
	Definir tamano_torta Como Entero;
...
Proceso El_pastelero
	...
	opciones_pastelero(opcion_torta, nombre);
